...
def get_threshold(feature, LLM):
    thresholds = {
        "LL": {"base": -2.7, "Claude": -2.9, "Dolly": -2.9, "StableLM": -3}, # likelihood
        "LRK": {"base": -1.4, "ChatGLM": -1.5, "Claude": -1.5, "StableLM": -1.55}, # log_rank
        "LRR": {"base": -2.01, "ChatGLM": -2.1, "Claude": -1.96, "StableLM": -1.98},
        "DG": {"base": 0.9, "Claude": 0.3, "Dolly": 0.3, "StableLM": 0.01}, # DetectGPT
        "NPR": {"base": 1, "ChatGPT": 1.03, "StableLM": 1.01, "Dolly": 1.02, "ChatGLM": 1.04}
    }
    return thresholds[feature].get(LLM, thresholds[feature]["base"])

def test(filepath, LLM, feature1=None, feature2=None, feature3=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--LLM', type=str, default="StableLM", help="ChatGPT, ChatGLM, Claude, Dolly, StableLM, GPT4All")
    ...
    test(f'/home/yangjing/AIGCDetect/extract_features/features/Essay', LLM, feature1, feature2, feature3)
