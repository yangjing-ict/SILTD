...
def get_threshold(feature, LLM):
    thresholds = {
        "LL": {"base": -2.7, "ChatGPT": -2.5, "ChatGLM": -2.4, "StableLM": -2.9},
        "LRK": {"base": -1.4, "Claude": -1.5, "StableLM": -1.55},
        "LRR": {"base": -2, "ChatGPT": -2.1, "ChatGLM": -2.2, "Dolly": -1.9},
        "DG": {"base": 0.9, "Claude": 0.3, "Dolly": 0.3, "StableLM": 0.1},
        "NPR": {"base": 1, "ChatGPT": 1.03, "StableLM": 1.01, "Dolly": 1.02, "ChatGLM": 1.07}
    }
...
def test(filepath, LLM, feature1, feature2=None, feature3=None):
    ...
    # 计算mulrirank
    x, y = multirank_cuda(graph) if feature1 and feature2 else multirank_cuda(graph[[0]])
...
if __name__ == "__main__":
    ...
    test(f'/home/yangjing/AIGCDetect/extract_features/features/Reuters', LLM, feature1, feature2, feature3)
